...
let GameManager = {
  ...
  standby : function() {
    ...
    if (findLocName() == 'Village'){
      this.stand.innerHTML = "<h2 class='display-3 title'>Village of Talle</h2><h5>Camps Left: " + me.camps + "</h5><h4 class='text-secondary fantasy'>"+ findLocDesc() + "</h4><h5>What would you like to do?</h5><br><div class='btn-group'><button onclick ='GameManager.inventory()' class='btn btn-dark'>View Inventory</button><button onclick ='me.rest()' class='btn btn-dark'>Rest</button><button onclick ='StoreManager.villageMarket()' class='btn btn-dark'>Shop</button><button onclick ='GameManager.viewStats()' class='btn btn-dark'>View Player</button><button onclick ='GameManager.map()' class='btn btn-dark'>Map</button><button onclick ='SaveSystem.saveScreen()' class='btn btn-light'>Save</button></div><br><br><div class='d-flex justify-content-center directions'><button type='button' class='btn btn-secondary' onclick = 'me.travel(1)'>North</button></div><div class='d-flex justify-content-center directions'><button type='button' class='btn btn-secondary' onclick = 'me.travel(4)'>West</button><button type='button' class='btn btn-secondary' onclick = 'me.travel(3)'>East</button></div><div class='d-flex justify-content-center directions'><button type='button' class='btn btn-secondary' onclick = 'me.travel(2)'>South</button></div>";
    } else if (findLocName() == 'City of Wall'){
      this.stand.innerHTML = "<h2 class='display-3 title'>City of Wall</h2><h5>Camps Left: " + me.camps + "</h5><h4 class='text-secondary fantasy'>"+ findLocDesc() + "</h4><h5>What would you like to do?</h5><br><div class='btn-group'><button onclick ='inventoryScreen()' class='btn btn-dark'>View Inventory</button><button onclick ='me.rest()' class='btn btn-dark'>Rest</button><button onclick ='StoreManager.cityMarket()' class='btn btn-dark'>Shop</button><button onclick ='GameManager.viewStats()' class='btn btn-dark'>View Player</button><button onclick ='GameManager.map()' class='btn btn-dark'>Map</button><button onclick ='SaveSystem.saveScreen()' class='btn btn-light'>Save</button></div><br><br><div class='d-flex justify-content-center directions'><button type='button' class='btn btn-secondary' onclick = 'me.travel(1)'>North</button></div><div class='d-flex justify-content-center directions'><button type='button' class='btn btn-secondary' onclick = 'me.travel(4)'>West</button><button type='button' class='btn btn-secondary' onclick = 'me.travel(3)'>East</button></div><div class='d-flex justify-content-center directions'><button type='button' class='btn btn-secondary' onclick = 'me.travel(2)'>South</button></div>";

    } else {
      this.stand.innerHTML = "<h2 class='display-3 title'>Camp</h2><h5>Camps Left: " + me.camps + "</h5><h3 class='fantasy'>"+ findLocName() + "</h3><h4 class='text-secondary fantasy'>"+ findLocDesc() + "</h4><h5>What would you like to do?</h5><br><div class='btn-group'><button onclick ='Battle.newBattle()' class='btn btn-dark'>Find Enemy</button><button onclick ='inventoryScreen()' class='btn btn-dark'>View Inventory</button><button onclick ='me.rest()' class='btn btn-dark'>Rest</button><button onclick ='GameManager.viewStats()' class='btn btn-dark'>View Player</button><button onclick ='GameManager.map()' class='btn btn-dark'>Map</button><button onclick ='SaveSystem.saveScreen()' class='btn btn-light'>Save</button></div><br><br><div class='d-flex justify-content-center directions'><button type='button' class='btn btn-secondary' onclick = 'me.travel(1)'>North</button></div><div class='d-flex justify-content-center directions'><button type='button' class='btn btn-secondary' onclick = 'me.travel(4)'>West</button><button type='button' class='btn btn-secondary' onclick = 'me.travel(3)'>East</button></div><div class='d-flex justify-content-center directions'><button type='button' class='btn btn-secondary' onclick = 'me.travel(2)'>South</button></div>";
    }
  },
